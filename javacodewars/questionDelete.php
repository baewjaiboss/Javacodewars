<?php
  ...
  for($i = 0 ; $i<count($question_id_array) ; $i++){
    ...
    $result5 = mysqli_query($dbcon, $sql5) or die(mysqli_error());
    if(!($result5)){
        response_message(500,"Unsuccess");
        return;
    }
    ...
    $result6 = mysqli_query($dbcon, $sql6) or die(mysqli_error());
    if(!($result6)){
        response_message(500,"Unsuccess");
        return;
    }
    ...
    $result7 = mysqli_query($dbcon,$sql7) or die(mysqli_error());
    ...
    if($result7 -> num_rows > 0) {
      ...
      while ($row7 = mysqli_fetch_assoc($result7)) {
        ...
        $result8 = mysqli_query($dbcon, $sql8) or die(mysqli_error());
        if(!($result8)){
            response_message(500,"Unsuccess");
            return;
        }
    ...
    $result9 = mysqli_query($dbcon, $sql9) or die(mysqli_error());
    if(!($result9)){
        response_message(500,"Unsuccess");
        return;
    }
