<?php
  ...
  if($result0 -> num_rows < 1) {  /** check ว่าเคยมีการเพิ่มโจทย์หรือยัง เพราะจะแสดงแต่โจทย์ที่ยังไม่เคยเพิ่ม */

    $sql = " SELECT * FROM question WHERE teacher_user = '$teacher_user' " ; /**ถ้ายังไม่มีแสดงคำถามทั้งหมดของอาจารย์ */
